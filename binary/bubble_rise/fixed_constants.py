...
rho_c = rho_h 
a_c = v_c**2 / l_c 
sigma_c = l_c * v_c**2 * rho_c 
eta_c = l_c * v_c * rho_c 

g_bar = g / a_c 
eta_h_bar = eta_h / eta_c 
rho_h_bar = rho_h / rho_c
d_bar = d / l_c 
sigma_bar = sigma / sigma_c


T = 1500
CFL = 0.2
initBubbleDiam = d_bar
...
beta = 12*sigma_bar/eps

kappa = 3*sigma_bar*eps/2 
...
xi = [
    fe.Constant((0.0,  0.0)),
    fe.Constant((v_c*1.0,  0.0)),
    fe.Constant((0.0,  v_c*1.0)),
    fe.Constant((v_c*-1.0,  0.0)),
    fe.Constant((0.0, v_c*-1.0)),
    fe.Constant((v_c*1.0,  v_c*1.0)),
    fe.Constant((v_c*-1.0,  v_c*1.0)),
    fe.Constant((v_c*-1.0, v_c*-1.0)),
    fe.Constant((v_c*1.0, v_c*-1.0)),
]
