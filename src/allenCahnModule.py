...
class allenCahn:
    ...
    def __init__(self, V, xc, yc, initDropDiam, interfaceThickness,
        ...
        def assembleRhsPhiLumping (self, phi_n, f_n,
            ...
            lin_form_AC = (
                ...
                * fe.dot(moments.getVel(f_n, xi, forceDensityTuple, dt),
                ...
                - dt * M_tilde * self.v * self.mu_n * fe.dx
        ...
        def assembleRhsMu(self, ds_bottom):
            ...
            *np.cos(self.theta)*(self.phi_n**2-1)*self.v*self.ds_bottom )
