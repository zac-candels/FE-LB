...
def computeForceMultiPhase(forceDensity, v, forceVec_x, forceVec_y,
                 forceDensity_x, forceDensity_y, massMat):
    
    fe.assemble(forceDensity[0]*v*fe.dx, tensor=forceVec_x )
    fe.assemble(forceDensity[1]*v*fe.dx, tensor=forceVec_y)
...
def computeForcePoiseuille(Force_density, v, forceVec_x, forceVec_y,
                 forceDensity_x, forceDensity_y, massMat):
