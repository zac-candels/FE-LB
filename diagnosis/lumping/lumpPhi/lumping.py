...
WORKDIR = os.getcwd()
outDirName = os.path.join(WORKDIR, "lumping") #f"theta{theta_deg}_tau{tau}_A{A}_kappa{kappa}_M{M_tilde}") #f"figures_CA{theta_deg}")
...
lin_form_AC = - dt*q*fe.dot(getVel(f_n, force_density), fe.grad(phi_n))*fe.dx\
